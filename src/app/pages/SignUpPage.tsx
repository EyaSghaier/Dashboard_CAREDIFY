...
const i18n = {
  FR: {
    title: 'Demander accès', subtitle: 'Rejoignez la plateforme Caredify',
    step1: 'Compte', step2: 'Profil', step3: 'Confirmation',
    fullName: 'Nom complet', fullNamePh: 'Dr. Nom Complet',
    email: 'Email professionnel', emailPh: 'docteur@caredify.tn',
    ...
    license: 'N° Ordre des Médecins', licensePh: '*************',
    ...
    phone: 'Téléphone', phonePh: '20 123 456',
    next: 'Suivant', back: 'Retour', submit: 'Demander accès',
    ...
    errorPhone: 'Le numéro doit contenir exactement 8 chiffres',
    ...
    confirmSub: 'Cliquez sur "Demander accès" pour finaliser votre inscription.',
  },
  EN: {
    title: 'Request access', subtitle: 'Join the Caredify platform',
    step1: 'Account', step2: 'Profile', step3: 'Confirm',
    fullName: 'Full name', fullNamePh: 'Dr. Full Name',
    email: 'Professional email', emailPh: 'doctor@caredify.tn',
    ...
    license: 'Medical License No.', licensePh: '*************',
    ...
    phone: 'Phone', phonePh: '20 123 456',
    next: 'Next', back: 'Back', submit: 'Request access',
    ...
    errorPhone: 'Phone number must contain exactly 8 digits!',
    ...
    confirmSub: 'Click "Request access" to complete your registration.',
  },
};
